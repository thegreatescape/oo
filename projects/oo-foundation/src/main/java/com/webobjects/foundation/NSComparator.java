...
public abstract class NSComparator<T> implements Comparator<T> {
  ...
  public static final NSComparator<String> AscendingStringComparator = (NSComparator<String>) AscendingComparableComparator;	
	...
	public static final NSComparator<Integer> AscendingNumberComparator = (NSComparator<Integer>) AscendingComparableComparator;
	public static final NSComparator<Integer> DescendingNumberComparator = (NSComparator<Integer>) DescendingComparableComparator;
